...
type StoryblokEntry_first_published_atArgs = {
  difference: InputMaybe<Scalars['String']>;
  formatString: InputMaybe<Scalars['String']>;
  fromNow: InputMaybe<Scalars['Boolean']>;
  locale: InputMaybe<Scalars['String']>;
...
type HomeQueryQuery = { readonly storyblokEntry: { readonly content: string | null, readonly name: string | null, readonly full_slug: string | null, readonly uuid: string | null, readonly id: string, readonly internalId: number | null } | null };

type NavigationQueryVariables = Exact<{ [key: string]: never; }>;


type NavigationQuery = { readonly navigation: { readonly name: string | null, readonly full_slug: string | null, readonly content: string | null } | null };
